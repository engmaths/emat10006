...
This is a group project to be completed in groups of 4 students. You should
...
Your Project Report should be a Jupyter Notebook and should be stored in your
GitHub repo. Note though that a binary Word file can not be efficiently stored
in git so if you want to add your report as a Word document then just add it
once at the very end of your project (when you will not need to make any
further changes).
...
* IMPORTANT: The README must explain exactly how to run your code (i.e. which
  file should be run and with what command line arguments).
